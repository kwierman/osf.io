# -*- coding: utf-8 -*-
"""Utility functions for the ownCloud add-on.
"""
...
def serialize_settings(node_settings, current_user):
    """
    View helper that returns a dictionary representation of a OwncloudNodeSettings record. Provides the return value for the owncloud config endpoints.
    """
    user_settings = node_settings.user_settings
    user_is_owner = user_settings is not None and (
        user_settings.owner._primary_key == current_user._primary_key
    )
    current_user_settings = current_user.get_addon('owncloud')
    rv = {
