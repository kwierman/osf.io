...
response_dict = {
    dryad_settings.DRYAD_DATAONE_METADATA.format('doi:10.5061/dryad.1850') :u"""
        ...
        """,
        dryad_settings.DRYAD_DATAONE_LIST : u"""
        ...
        """,
        dryad_settings.DRYAD_FILE_METADATA.format('doi:10.5061/dryad.1850/1') : """
...
class DryadTestConnection:
    """
        Stand in Unit Test replacement for DryadConnection.

        This can be swapped for using httpretty during the v2 upgrade.
        For now, the API is simple enough to not need any more scaffolding
        than this.
    """
...
class DryadTestRepository(dryad_utils.DryadRepository):
    def __init__(self, connection=DryadTestConnection()):
